...
<script src="//cdnjs.cloudflare.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    ...
    <title>Tutor  Sign Up Page </title>
</head>
<body>
<nav class="navbar navbar-expand-lg navbar-light navbar-laravel">
    <div class="container">
    <a class="navbar-brand" href="#">Tutor Registration Page</a>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="success.php" method="">
                                ...
                                <div class="form-group row">
                                    <label for="Grade_Level" class="col-md-4 col-form-label text-md-right">Grade_Level (enter as only a number)</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="SAT/ACT Score" class="col-md-4 col-form-label text-md-right">SAT/ACT Score </label>
                                    <div class="col-md-6">
                                        <input type="text" id="SAT/ACT Score" class="form-control" name="SAT/ACT Score">
                                ...
                                <form action="/action_page.php">
                                 ...
                                 <label for="AP Chemistry">AP Chemistry</label><br>
                                 <input type="checkbox" id="AP Physics 1" name="AP Physics 1" value="AP Physics 1">
                                 <label for="AP Physics 1">AP Physics 1</label><br>
                                 <input type="checkbox" id="AP Physics 2" name="AP Physics 2" value="AP Physics 2">
                                 <label for="AP Physics 2">AP Physics 2</label><br>
                                 <input type="checkbox" id="AP Physics C" name="AP Physics C" value="AP Physics C">
                                 <label for="AP Physics C">AP Physics C</label><br>
                                 <input type="checkbox" id="AP Environmental Science" name="AP Environmental Science" value="AP Environmental Science">
                                 ...
                                 <label for="AP Literature">AP Literature</label><br><br>
                                 <input type="checkbox" id="Pre-AP Computer Science" name="Pre-AP Computer Science" value="Pre-AP Computer Science">
                                 <label for="Pre-AP Computer Science">Pre-AP Computer Science</label><br>
                                 <input type="checkbox" id="AP Computer Science" name="AP Computer Science" value="AP Computer Science">
                                 <label for="AP Computer Science">AP Computer Science</label><br>
                                    </form>
                                    <div class="col-md-6 offset-md-4">

                                                                  <form name="my-form" onsubmit="return validform()" action="success.php" method="">
                                                                      <div class="form-group row">
                                                                          <label for="APScores" class="col-md-4 col-form-label text-md-left">AP Scores (list all scores for subjects you signed up for)</label>
                                                                          <div class="col-md-6">
                                                                              <input type="text" id="APScores" class="form-control" name="APScores">
                                                                          </div>
                                                                      </div>
